...
> **Regional references:** For Egypt, load `seo-aeo-masri.md`. For Saudi Arabia, load `seo-aeo-ksa.md`. For Levantine (Syria/Lebanon/Jordan/Palestine), load `seo-aeo-levantine.md`.
