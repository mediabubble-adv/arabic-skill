...
- Version policy: `1.0.0` shipped (PRD §12 + P1–P6); **`1.1.0` shipped** (P7 website G13–G18, P8 runtime); **`1.1.1`** npm publish CI; **`1.2.0`** full Cursor npx install + skills.sh registry; **`1.2.1`** git-clone npx fix (`@latest`); research R4 and onboarding remain next.
...
- Current product version is `1.2.1` on branch `main`; `1.2.0` full Cursor + skills.sh; `1.1.1` tagged; `1.1.0` website + P8 runtime.
