...
- Version policy: `1.0.0` shipped (PRD §12 + P1–P6); **`1.1.0` shipped** (P7 website G13–G18, P8 runtime, npx installer scaffold); `npx skills add` registry and npm publish remain distribution follow-ups.
...
- Current product version is `1.1.0` tagged `v1.1.0` on `main` (PR #49) in root `VERSION`, `CHANGELOG.md`, `package.json`, and `arabic/SKILL.md`.
