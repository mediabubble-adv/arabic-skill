...
- Version policy: `1.0.0` shipped (PRD §12 + P1–P6); **`1.1.0` shipped** (P7 website G13–G18, P8 runtime); **`1.1.1`** npm publish CI; **`1.2.0`** full Cursor npx install + skills.sh registry; **`1.2.1`** git-clone npx fix (`@latest`); **1.2.x train** shipped through **`1.2.6`** (validation stack + G1–G12 scenario manifest + opt-in `golden:harness`); **`1.2.7` in progress** — signal presets, `--report`, nightly workflow.
