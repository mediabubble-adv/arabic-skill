...
- [ ] Arabic length guidance distinguishes English→Arabic expansion vs native short-form (see caption intro + X row)

## G-RQ010-02 — Write task behavior

**Command:** `/arabic write instagram` for an Egyptian lifestyle product caption.

**Expected:** Agent respects 50–150 char optimal band and 5–10 hashtag guidance from `arabic/dialects/masri.md` §5 without loading full `reference/arabic-masri/`.

**Command:** `/arabic write tiktok` for the same brief.

**Expected:** Agent targets 20–50 char caption band and 3–5 hashtags from `arabic/dialects/masri.md` §5.
